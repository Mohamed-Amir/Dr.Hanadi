            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)"
                       aria-expanded="false">
                        ...
                        <span class="hide-menu"> اعدادات الاقسام </span>
                    </a>
                    <ul aria-expanded="false" class="collapse  first-level">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link  waves-effect waves-dark" href="{{route('Testimonials.index')}}" aria-expanded="false">
                        ...
                        <span class="hide-menu">الشهادات</span>
                    </a>
                </li>

                <li class="sidebar-item">
                    <a class="sidebar-link  waves-effect waves-dark" href="{{route('DrHanadi.index')}}" aria-expanded="false">
                        <i class="fa fa-book"></i>
                        <span class="hide-menu">معلومات الدكتوره هنادي</span>
                    </a>
                </li>
