                    ...
                    <div class="d-flex no-block justify-content-end align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> مشتركي الرسائل الاخباريه </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex no-block align-items-center m-b-30">
                                <h4 class="card-title"> مشتركي الرسائل الاخباريه</h4>
                                <div class="ml-auto">
                                    <div class="btn-group">
                                        &nbsp;
...
@section('script')
    ...
    @include('Admin.NewsLetter.script')
